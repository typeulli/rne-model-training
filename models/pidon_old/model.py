...
class FieldDerivatives:
    ...
    when :meth:`PiDoNOld.derivatives` is called with ``second_order=False``.
    """
...
class PiDoNOld(nn.Module):
    ...
    def __init__(
        ...
        (see ``models/pidon_old/loss.laser_flux``) travels with the checkpoint instead of
