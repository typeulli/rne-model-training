"""Turn the shared point cloud into the six batches PiDoNOld's PINN loss consumes.
...
class PiDoNOldDataset:
    """Samplers for every term of :class:`~models.pidon_old.loss.PINNLoss`.
