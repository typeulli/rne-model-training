"""Train RGFDoN: :mod:`models.gfdon` with the beam frame held over dark travel.

Invoked through the top-level dispatcher::

    python train.py rgfdon --iterations 140000 --batch-data 4096         --hidden 64 64 64 --latent-dim 16 --cede-radius 2.5e-3

Everything is :mod:`models.gfdon`'s -- same corpus, same split, same network,
