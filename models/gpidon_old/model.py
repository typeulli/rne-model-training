...
class FieldDerivatives:
    ...
    when :meth:`GPiDoNOld.derivatives` is called with ``second_order=False``.
    """
...
class GPiDoNOld(nn.Module):
    ...
    ``g`` is :func:`~models.gpidon_old.laser.beam_gaussian`, a unit-peak Gaussian riding
    ...
    def __init__(
        ...
        ``models/gpidon_old/loss.laser_flux`` is unaffected -- it stays the calibrated Gaussian.
