"""Turn the shared point cloud into the six batches GPiDoNOld's PINN loss consumes.
...
class GPiDoNOldDataset:
    """Samplers for every term of :class:`~models.gpidon_old.loss.PINNLoss`.
