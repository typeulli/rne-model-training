"""JFDoN behind the shared :class:`~agent.BaseAgent` inference contract.
...
reason :class:`~models._pathdon.PathAgent` gives.
    ...
    from models.jfdon import build_agent
...
def build_agent(
    ...
    """Rebuild JFDoN and the time grid its answer lives on."""
