"""DoN behind the shared :class:`~agent.BaseAgent` inference contract.
...
:class:`~models._pathdon.PathAgent` explains why that is the right place for it.
    ...
    from models.don import build_agent
...
def build_agent(
    ...
    """Rebuild DoN from the architecture stored alongside its weights."""
