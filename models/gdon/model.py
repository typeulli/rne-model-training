...
class GDoN(nn.Module):
    ...
    codes are combined by an inner product, multiplied by
    :func:`~models.gdon.laser.beam_gaussian` and offset by the operator bias, to
    predict the temperature ``T_hat(x, y, z, t; P)``.
