"""The PINN objective for GPiDoN, and the physical constants it is built from.
...
from .model import FieldDerivatives, GPiDoN
...
def laser_flux(coords: Tensor, power: Tensor) -> Tensor:
    ...
    calibrated Gaussian; the network's own envelope in :func:`~models.gpidon.laser.beam_gaussian`
