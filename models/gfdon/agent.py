"""GFDoN behind the shared :class:`~agent.BaseAgent` inference contract.
...
reason :class:`~models._pathdon.PathAgent` gives.
    ...
    from models.gfdon import build_agent
...
def build_agent(
    ...
    """Rebuild GFDoN and the time grid its answer lives on."""
