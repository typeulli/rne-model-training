"""The supervised objective of CGMLP: mean squared error, and nothing else.
...
in :mod:`models.cmlp.loss` -- which is the whole point of this model, since
``cmlp`` differs from it only by the absence of the Gaussian gate.
"""
