"""RJFDoN behind the shared :class:`~agent.BaseAgent` inference contract.

Identical to :mod:`models.jfdon`'s agent except that the beam frame it asks for
...
def build_agent(
    ...
    """Rebuild RJFDoN, its time grid, and the frame it was fitted in."""
