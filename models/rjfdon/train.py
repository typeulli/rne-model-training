"""Train RJFDoN: :mod:`models.jfdon` with the beam frame held over dark travel.

Invoked through the top-level dispatcher::

    python train.py rjfdon --iterations 140000 --batch-data 4096         --hidden 64 64 64 --latent-dim 16 --cede-radius 2.5e-3
