"""Train RFDoN: :mod:`models.fdon` with the beam frame held over dark travel.

Invoked through the top-level dispatcher::

    python train.py rfdon --iterations 140000 --batch-data 4096         --hidden 64 64 64 --latent-dim 16 --cede-radius 2.5e-3

Everything is :mod:`models.fdon`'s -- same corpus, same split, same network,
